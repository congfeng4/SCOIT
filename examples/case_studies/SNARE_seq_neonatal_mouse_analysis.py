...
def load_data():
    ...
    ATAC_data = pd.read_csv("data/SNARE_seq_neonatal_mouse/ATAC_lsi.csv", index_col=0, na_filter=False).to_numpy()[
        :, 1:]
...
if __name__ == "__main__":
    ...
    save_scoit_embeddings(sc_model, "SNARE_seq_neonatal_mouse", predict_data)
